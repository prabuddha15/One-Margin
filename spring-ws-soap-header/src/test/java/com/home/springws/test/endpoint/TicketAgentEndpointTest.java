//package com.home.springws.test.endpoint;
//
...
//						+ "<flightNumber>202</flightNumber>"
//						+ "</v1:listFlightsResponse>");
//
//		mockClient.sendRequest(withSoapEnvelope(requestEnvelope)).andExpect(
